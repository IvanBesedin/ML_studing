# ============================================================================
# RANDOM FOREST + RANDOMIZED SEARCH CV — ТОЛЬКО МЕТРИКИ
# ============================================================================
import json
import os
import time
...
def create_param_grid(cv_params: dict) -> dict:
    ...
    param_distributions = {
        ...
        'min_samples_leaf': cv_params.get('min_samples_leaf', [1, 5, 10, 15, 20]),
        'max_features': cv_params.get('max_features', ['sqrt', 'log2']),
...
def main():
    ...
    metrics_output = "metrics/cv_random_forest_metrics.json"

    # Загрузка параметров
    print(f"\n📂 Загрузка параметров из: {params_path}")
    all_params = load_params(params_path)
    cv_params = all_params.get("cv_random_forest", {})
